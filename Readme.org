...
- [[#development-journal][Development Journal]]
  - [[#local-database-testing][Local Database Testing]]
    ...
    - [[#implement-modify-seeding-script-to-store-10-million-records-23][IMPLEMENT Modify seeding script to store 10 million records]]
...
Inserting with an existing primary key updates the row.

*** IMPLEMENT Connect to the Postgres from the server

*** IMPLEMENT Modify seeding script to store 10 million records [2/3]
...
I tried another approach  using the [[https://docs.datastax.com/en/developer/nodejs-driver/4.2/api/module.concurrent/][executeConcurrent]] function from cassandra-driver to concurrently run inserts with batch size of 10,000. This approach finished in two and a half minutes and used about 200MB less memory. Seeding a full 10 million records takes around 25 minutes.
