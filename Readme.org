...
- [[#development-journal][Development Journal]]
  - [[#local-database-testing][Local Database Testing]]
    ...
    - [[#implement-modify-seeding-script-to-store-10-million-records-03][IMPLEMENT Modify seeding script to store 10 million records]]
...
I had to specify the contact point to connect to which I found by running ~nodetool status~ as root and looking for the rack name.
...
*** IMPLEMENT Modify seeding script to store 10 million records [0/3]
